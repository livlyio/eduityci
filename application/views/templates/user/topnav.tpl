            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-success">{$notes.msgs.count}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have {$notes.msgs.count} unread messages</li>
                  <li>
                    <!-- inner menu: contains the actual data -->
                    <ul class="menu">
                    {foreach from=$notes.msgs.recent item=r}
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
              ...
              <li class="dropdown notifications-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-warning">{$notecount}</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have {$notecount} notifications</li>
                  <li>
                    <!-- inner menu: contains the actual data -->
                    <ul class="menu">
                      <li>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{base_url('account/account/logout')}" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
