      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; {date("Y")} <a href="http://www.eduity.net">Ed<b>U</b>ity LLC</a>.</strong> All rights reserved.
      </footer>
   ...
   <!-- Sparkline -->
    ...
    <script src="{base_url('adminlte/plugins/slimScroll/jquery.slimscroll.min.js')}" type="text/javascript"></script>
    <!-- ChartJS 1.0.1 -->
    <script src="{base_url('adminlte/plugins/chartjs/Chart.min.js')}" type="text/javascript"></script>

    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="{base_url('adminlte/dist/js/pages/dashboard2.js')}" type="text/javascript"></script>
