...
<script src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
        ...
        <script src="{$smarty.const.HTTP_JS_PATH}jquery-1.9.1.min.js"></script>
        <script src="{$smarty.const.HTTP_JS_PATH}jquery.mockjax.js"></script>

        <link href="http://vitalets.github.io/x-editable/assets/bootstrap300/css/bootstrap.css" rel="stylesheet">
        <script src="./X-editable Demo_files/bootstrap.js"></script>

        <!-- bootstrap-datetimepicker -->
   <!--     <link href="http://vitalets.github.io/x-editable/assets/bootstrap-datetimepicker/css/datetimepicker.css" rel="stylesheet">
        <script src="./X-editable Demo_files/bootstrap-datetimepicker.js"></script>                  -->
