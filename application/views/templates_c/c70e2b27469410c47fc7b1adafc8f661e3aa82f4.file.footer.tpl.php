...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '728553a93ec335df5-57903893',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_553a93ec346f06_79969240',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_553a93ec346f06_79969240')) {function content_553a93ec346f06_79969240($_smarty_tpl) {?>            <div class="box-footer">
 ...
 <a href="http://www.eduity.net">Ed<b>U</b>ity LLC</a>.</strong> All rights reserved.
      </footer>
...
>
    <!-- Bootstrap 3.3.2 JS -->
    <?php echo '<script'; ?>
 src="<?php echo base_url('adminlte/bootstrap/js/bootstrap.min.js');?>
...
>
    <!-- FastClick -->
    <?php echo '<script'; ?>
 src='<?php echo base_url('adminlte/plugins/fastclick/fastclick.min.js');?>
'><?php echo '</script'; ?>
>
    <!-- AdminLTE App -->
    <?php echo '<script'; ?>
 src="<?php echo base_url('adminlte/dist/js/app.min.js');?>
" type="text/javascript"><?php echo '</script'; ?>
>
   <!-- Sparkline -->
    <?php echo '<script'; ?>
