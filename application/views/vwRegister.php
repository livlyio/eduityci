<div id="container" class="ltr">
	...
	<form id="form1" name="form1" class="wufoo topLabel page1" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" novalidate
      action="https://eduity.wufoo.com/forms/untitled-form/">
						...
						<ul>
							...
							<li>							
								<small>
									...
									Password length must be more than characters in length.<br/>Only alpha-numeric, dashes, underscores, periods and comma characters are allowed.
								</small>
							</li>
							<li class="info_req">
