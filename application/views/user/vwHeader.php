    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(); ?>">Eduity User Panel</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li <?php echo  $pg =='organization' ? 'class="active"' : '' ?>><a href="<?php echo base_url(); ?>admin/redirects">Organization</a></li>
            <li <?php echo  $pg =='other' ? 'class="active"' : '' ?>><a href="<?php echo base_url(); ?>admin/twitter">Other</a></li>
